    ...
    $.ajax({
      ...
      success: function(response){
        ...
        for (var i = 0; i < len; i++) {
            ...
            user_contact_number.User_contact_number.push(response[i].contact_number);
            console.log(response[i].contact_number)
        }
        ...
        $('#contact_number').val(user_contact_number.User_contact_number);
